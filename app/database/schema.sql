...
CREATE TABLE IF NOT EXISTS alcoholic_drinks (
    ...
    ad_type VARCHAR(50),  -- Cream, liquor, cocktail, gin
    flavour VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS kits (
    product_id INTEGER PRIMARY KEY,
    k_type VARCHAR(50),  -- Type of Kit (Espadín, Regalo, Degustacion, Variado)
...
CREATE TABLE IF NOT EXISTS salts (
    product_id INTEGER PRIMARY KEY,
    s_type VARCHAR(50),  -- Type of salt (e.g, gusano, chapulin)
